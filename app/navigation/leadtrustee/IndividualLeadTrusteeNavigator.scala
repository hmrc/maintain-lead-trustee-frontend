...
import pages.Page
import pages.leadtrustee.individual.{
  CountryOfNationalityInTheUkYesNoPage, CountryOfResidenceInTheUkYesNoPage, EmailAddressYesNoPage, LiveInTheUkYesNoPage,
  UkCitizenPage, _
}
...
object IndividualLeadTrusteeNavigator extends LeadTrusteeNavigator {
  ...
  private def simpleNavigation: PartialFunction[Page, UserAnswers => Call] = {
    ...
    case NationalInsuranceNumberPage | PassportOrIdCardDetailsPage =>
      _ => CountryOfResidenceInTheUkYesNoController.onPageLoad()
  ...
  private def yesNoNavigation: PartialFunction[Page, UserAnswers => Call] = {
    case CountryOfNationalityInTheUkYesNoPage =>
      ua =>
        yesNoNav(
          ...
          CountryOfNationalityController.onPageLoad()
        )
    case UkCitizenPage                        =>
      ua =>
    ...
    case LiveInTheUkYesNoPage                 =>
      ua => yesNoNav(ua, LiveInTheUkYesNoPage, UkAddressController.onPageLoad(), NonUkAddressController.onPageLoad())
